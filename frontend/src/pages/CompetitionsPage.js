            ...
            <div className={`relative ${featured ? 'aspect-[16/10]' : 'aspect-[4/3]'}`}>
                ...
                <div className="absolute top-3 left-3 flex gap-2">
                    {comp.competition_type === 'instant_win' ? (
                        ...
                        <span className="px-2.5 py-1 bg-emerald-600 text-white text-[10px] font-bold rounded-lg shadow-lg">
                            CLASIC
                        </span>
                    )}
                    {comp.is_flash_sale && (
                        <span className="px-2.5 py-1 bg-amber-500 text-white text-[10px] font-bold rounded-lg shadow-lg flex items-center gap-1">
...
const CompetitionsPage = () => {
    ...
    const categories = [
        ...
        { id: 'auto', label: isRomanian ? 'Auto' : 'Cars', icon: Car },
    ];
