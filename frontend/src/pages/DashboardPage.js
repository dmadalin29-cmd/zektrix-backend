...
import { 
    ...
    ArrowUpRight, Gift, 
    ChevronRight, Activity, User, Save, Phone, Mail
} from 'lucide-react';
...
const DashboardPage = () => {
    ...
    const handleProfileUpdate = async () => {
        try {
            ...
            toast.success(isRomanian ? 'Profil actualizat cu succes!' : 'Profile updated successfully!');
        } catch (error) {
            console.error('Profile update error:', error);
            toast.error(isRomanian ? 'Eroare la actualizarea profilului' : 'Error updating profile');
        } finally {
    ...
    const handleTabChange = (value) => {
        setActiveTab(value);
        const routes = { overview: '/dashboard', locs: '/dashboard/tickets', history: '/dashboard/history', referral: '/dashboard/referral', account: '/dashboard/account' };
                            ...
                            <div className="rounded-2xl p-6 md:p-8"
                                ...
                                <div className="flex items-center gap-4 mb-8">
                                    <div className="w-16 h-16 rounded-2xl flex items-center justify-center"
                                        style={{ background: 'linear-gradient(135deg, #8b5cf6, #7c3aed)', boxShadow: '0 0 30px rgba(139, 92, 246, 0.4)' }}>
                                        <User className="w-8 h-8 text-white" />
                                    </div>
                                    <div>
                                        <h3 className="text-2xl font-bold text-white">{isRomanian ? 'Setări Cont' : 'Account Settings'}</h3>
                                        <p className="text-gray-400">{isRomanian ? 'Modifică informațiile tale personale' : 'Update your personal information'}</p>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 transition-all"
                                                placeholder={isRomanian ? 'Introdu prenumele' : 'Enter first name'}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 transition-all"
                                                placeholder={isRomanian ? 'Introdu numele' : 'Enter last name'}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 transition-all"
                                                placeholder={isRomanian ? 'Ex: +40 712 345 678' : 'Ex: +40 712 345 678'}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                disabled
                                                className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-gray-500 cursor-not-allowed"
                                                data-testid="input-email"
                                            />
                                        </div>
                                        <p className="text-xs text-gray-600 mt-1">
                                            {isRomanian ? 'Email-ul nu poate fi modificat' : 'Email cannot be changed'}
                                        </p>
                                    </div>

                                    {/* Username Display */}
                                    <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                                        <p className="text-xs text-gray-500 mb-1">{isRomanian ? 'Numele de utilizator' : 'Username'}</p>
                                        <p className="text-lg font-bold text-violet-400">{user?.username || 'N/A'}</p>
                                    </div>
