                    ...
                    <div className="max-w-2xl mx-auto px-4 text-center">
                        <div className="mb-8">
                            ...
                            <p className="text-xl text-muted-foreground">
                                {isRomanian 
                                    ? `Ai achiziționat ${purchasedTickets.length} locuri cu succes!`
                                    : `You successfully purchased ${purchasedTickets.length} locuri!`
                                }
                            </p>
                        </div>
                ...
                <main className="pt-24 pb-16">
                    <div className="max-w-2xl mx-auto px-4 text-center">
                        ...
                        <p className="text-muted-foreground mb-8">
                            {isRomanian 
                                ? 'Adaugă competiții în coș pentru a cumpăra locuri'
                                : 'Add competitions to your cart to buy locuri'
                            }
                        </p>
                        <Link to="/competitions">
                            <Button className="btn-primary">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                {totalItems} {totalItems === 1 
                                    ? (isRomanian ? 'loc' : 'ticket') 
                                    : (isRomanian ? 'locuri' : 'locuri')
                                }
                            </p>
                        </div>
                    </div>
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-muted-foreground mb-3">
                                                    £{item.ticket_price.toFixed(2)} {isRomanian ? 'per loc' : 'per ticket'}
                                                </p>
